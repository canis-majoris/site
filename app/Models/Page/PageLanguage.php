...
class PageLanguage extends Model  {
    ...
    protected $fillable = ['id', 'region_id', 'language_id', 'page_id', 'name', 'name_trans', 'status', 'text', 'short_text', 'seo_title', 'seo_description', 'seo_keywords', 'video', 'source', 'tags', 'img', 'alt', 'created_at', 'updated_at', 'deleted_at'];
    ...
    protected function manage_page_language_before_remove() {
