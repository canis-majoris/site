...
class SettingsLanguage extends Model  {
    ...
    protected $fillable = ['id', 'region_id', 'language_id', 'name', 'description', 'text', 'status', 'value', 'category', 'options', 'img', 'created_at', 'updated_at', 'deleted_at'];
    ...
    {
        return $this->belongsTo('App\Models\Settings\Settings', 'settings_id', 'id');
    }
    ...
    public function siblings() {
        return $this->settings->translated()->where('language_id', '!=', $this->language_id);
    }

    protected function manage_settings_language_before_remove() {
