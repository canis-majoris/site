<?php 
namespace App\Models\Multiroom;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\SoftDeletes;

class MultiroomControl extends Model  {
     ...
     * @var string
     */
    protected $table = 'multiroom_control';
    //protected $dates = ['deleted_at'];
    protected $fillable = ['id', 'region_id', 'date', 'stb_id', 'service_id', 'status', 'created_at', 'updated_at', 'deleted_at'];
