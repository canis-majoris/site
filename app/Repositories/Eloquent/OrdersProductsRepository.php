...
use App\Repositories\Contracts\OrdersProductsInterface;
...
class OrdersProductsRepository extends BaseRepository implements OrdersProductsInterface {

	/**
	 * @param OrdersProducts
	 */
	public function __construct(OrderProduct $model, Product $product, ProductStatus $product_status, Language $language, Order $order, OrderProductStatus $order_product_status, CartuTransaction $cartu_transaction, ProductStatusLog $product_status_log, User $user, Dealer $delaer) {
		$this->model 		        = $model->filterRegion();
		$this->product	            = $product->filterRegion();
		$this->product_status       = $product_status;
        $this->language             = $language->filterRegion();
        $this->order                = $order->filterRegion();
    ...
    public function saveData($data) {
        $op = $this->model->find($data['id']);
        $result = $op->saveHelper($data);
