...
<main class="mn-inner">
                            ...
                            <div class="row search-tabs-row search-tabs-container custom-accent-color-1">
                                <div class="col l6 m6 s12">
                                    <div class=" bred-c-holder-1" >
                                        <a href="{{route('home-index')}}">{{trans('main.breadcrumbs.home')}}</a> <span><i class="material-icons">keyboard_arrow_right</i></span> <a href="{{route('promos.index')}}" style="font-size:25px;">{{trans('main.breadcrumbs.promos')}}</a>
                                    </div>
                                </div>
                            ...
                            <div class="load-filter-container row deep-purple lighten-5">
                                ...
                                <div class="input-field col sl2 m2 s12">
                                    <select class="type_select-filter" name="type" id="type-select-filter">
                                        ...
                                        <option value="1">{{trans('main.promos.manage.form.all_promo')}}</option>
                                        <option value="2">{{trans('main.promos.manage.form.packet_promo')}}</option>
                                        <option value="3">{{trans('main.promos.manage.form.products_promo')}}</option>
                                    </select>
    ...
    <div class="fixed-action-btn">
        <a class="btn-floating btn-large waves-effect waves-light custom-main-color-1 menu-items-controll modal-trigger" id="add_btn" href="#manage_modal"><i class="material-icons dp48 tooltipped" data-position="top" data-delay="50" data-tooltip="Add promo" style="font-size: 30px;">playlist_add</i></a>
    </div>
</main>
	...
	(function(window,$){
		...
		window.LaravelDataTables["dataTableBuilder"] = $("#dataTableBuilder").DataTable({
			...
			"columns":[
                ...
                {"name":"status","data":"status","title":"{{trans('main.promos.table.header.status')}}","orderable":false,"searchable":false},
                {"name":"code", "data": 'code', "title":"{{trans('main.promos.table.header.code')}}","orderable":true,"searchable":true},
                {"name":"", "data": 'discount_type', "title":"{{trans('main.promos.table.header.discount_type')}}","orderable":false,"searchable":false},
                {"name":"", "data": 'discount_percents', "title":"{{trans('main.promos.table.header.discount_percents')}}","orderable":false,"searchable":false, 'width':'30%'},
				{"name":"date_start", "data": 'date_start', "title":"{{trans('main.promos.table.header.date_start')}}","orderable":true,"searchable":false},
                {"name":"date_end","data":"date_end","title":"{{trans('main.promos.table.header.date_end')}}","orderable":true,"searchable":false},
				{"name":"limit","data":"limit","title":"{{trans('main.promos.table.header.limit')}}","orderable":true,"searchable":false},
	    ...
	    $(document).on('click', '.stat-change',function(e) {
            e.preventDefault();
            url = "{{ route('promos-changestatus') }}";
            changestatus($(this), url);
        });

        $(document).on('click', '.show-promo-btn',function(e) {
            $('.show-promo-btn').off('click');
            e.preventDefault();
            var url = "{{ route('promos.edit.show') }}";
