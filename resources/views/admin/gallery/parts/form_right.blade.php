<ul class="collection with-header">
	<li class="collection-header side-collection-header custom-accent-color-1" style="padding-left: 28px;">
    	<a class="menu-items-controll modal-trigger waves-effect waves-light" id="add_menu_item_btn" href="#add_menu_item_modal"><i class="material-icons dp48 tooltipped" data-position="top" data-delay="50" data-tooltip="{{ trans('main.catalog.sidebar.menu.tools.add_item') }}">playlist_add</i></a>
	...
	<li data-id="{{$m_i->id}}" class="collection-item @if(isset($current_menu_item_id) && $current_menu_item_id == $m_i->id) active @endif">
	    <a href="#">
	        <h4 class="mail-title">{!! $m_i->title !!}</h4>
