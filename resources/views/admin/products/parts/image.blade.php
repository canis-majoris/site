...
<div class="col l12 m12 s12" style="padding-top:30px;" id="image_upload_input-wrapper">
    ...
    <div class="col l3 m4 s12" style="padding: 0;">
      ...
      <!-- <button type="button" class="delete_image-btn btn" @if($translated != null && $translated->img)  @else disabled @endif data-reset="{{trans('main.buttons.delete')}}">{{trans('main.buttons.delete')}}</button> -->
  </div>
</div>
