<form id="edit_product_form">
    ...
    <input type="hidden" name="op_type" id="op_type" value="stbs">
    <div class="modal-content row">
        <h4>{{trans('main.misc.edit')}} {{$product->code}}</h4>
        <div class="row">
            <div class="deep-purple lighten-5 wrapper-custom-1" style="margin-bottom: 15px; padding: 0.75rem;">
                <div class="input-field col s12">
                    <input style="font-size: 1.3rem; text-transform: uppercase;" id="mac" type="text" class="validate" value="{{$product->mac}}" name="mac" @if($product->products_statuse_id == 1) disabled @endif>
                    <label for="mac" class="input-label-1 active">{{trans('main.orders_products.manage.form.mac')}}</label>
                </div>
                <div class="clear"></div>
            </div>
            <div class="clear"></div>
            <div class="deep-purple lighten-5 wrapper-custom-1" style="padding: 0.75rem; margin-bottom: 1rem;">
