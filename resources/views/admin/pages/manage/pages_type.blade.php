<!-- Add Menu Item -->
<form id="manage_pages_type_form" class="edit_menu_item-form">
    <div class="modal-content row">
        <div class="col s12">
            <h4>{{ trans('main.content.pages_types.manage.title') }}</h4>
        </div>
        ...
        <div class="input-field col s12">
            ...
            <label for="m_i_n_name">{{ trans('main.content.pages_types.manage.form.name') }}</label>
        </div>
        <div class="input-field col s12">
            ...
            <label for="m_i_title">{{ trans('main.content.pages_types.manage.form.title') }}</label>
        </div>
        <div class="input-field col s12">
            <span>{{ trans('main.content.pages_types.manage.form.description') }}</span>
        ...
        <div class="input-field col s12">
            <p class="">
                ...
                <label for="m_i_n_watch">{{ trans('main.content.pages_types.manage.form.public') }}</label>
            </p>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var url_sp = "{{route('pages_types-save')}}";
        var form_sp = $('#manage_pages_type_form');
        ...
        @if($pages_type != null)$('#manage_pages_type_form').find('label.input-label-1').addClass('active');@endif
    });
</script>
