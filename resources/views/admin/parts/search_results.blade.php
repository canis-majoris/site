        ...
        <div class="row">
            <div class="col s12 search-head">
                <div class="row">
                    <div class="col s12">
                        <div class="left">
                            <p class="search-results-title">{{ trans('main.misc.Quick search results') }}</p>
            ...
            <div class="col s12 m4 search-result-container">
                <div class="card card-transparent">
                    <div class="row valign-wrapper">
                        <div class="col s3">
                            <img src="" alt="" class="circle responsive-img z-depth-1">
                        </div>
                        <div class="col s9">
            ...
            <!-- <div class="col s12 m4 search-result-container">
                ...
                <div class="card card-transparent">
                    ...
                    <div class="card-action">
                        <span class="grey-text">27 January 2018</span>
                    </div>
                </div>
            </div> -->
        </div>
